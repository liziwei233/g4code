...
float x1[]={20,50,100,112,140,200};
float y1[]={154,153,141,139,151,152};
float y1cor[]={116,111,107,107,111,116};

/*
float x2[]={4,7,12,17,21,28,35,42,49,70,};
float y2[]={170,164,172,154,171,168,170,167,161};
float y2col[]={141.2,139,142,140,137,146,146,140,131};
*/
/*
...
mydraw.Graph(g1,"Threshold (mV)","Dark Noise (s^{-1}) ",1.5,20,4);
g1->GetYaxis()->SetTitleOffset(0.5);
g1->GetYaxis()->SetRangeUser(98,190);
mydraw.Graph(g1,"Threshold (mV)","Time res (ps) ",1.8,47,4);
mydraw.Graph(g2,"Threshold (mV)","Time res (ps) ",1.5,20,2);
TLegend *leg=mydraw.Leg(0.6,0.7,0.85,0.9);
leg->AddEntry(g1,"no correction","lp");
leg->AddEntry(g2,"with correction","lp");
leg->Draw();
/*
...
//l->Draw();
*/
sprintf(buff,"threshold_TR.png",name);
//
c1->SaveAs(buff);
