...
void OSC_wv_analysis(){
    ...
    for (int s=0;s<n;s++)
    {
        ...
        TCut cMCPy = "MCP1_global_maximum_y>0.002";
        TCut cMCPQ = "MCP1_all_charge>0.02";

        TCut cSiPMy = "MCP2_global_maximum_y>0.0015";
        TCut cSiPMQ = "MCP2_all_charge>0.1";
        TCut cSiPMQ_3 = "MCP2_all_charge>0.1";
